...
def add_journal_entry():
    ...
    journal_entries = utils.load_items("Backend/data/journals.json") # Load existing journal entries
    journal_entries.append(entry) # Add new entry
    utils.save_items("Backend/data/journals.json", journal_entries) # Save updated entries
